...
public:
    class Type_fr_xarm_mount_X_fr_xarmlink3 : public TransformMotion<Scalar, Type_fr_xarm_mount_X_fr_xarmlink3>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarm_mount_X_fr_xarmlink3();
        const Type_fr_xarm_mount_X_fr_xarmlink3& update(const JState&);
    protected:
    };
    
    class Type_fr_xarmlink3_X_fr_xarm_mount : public TransformMotion<Scalar, Type_fr_xarmlink3_X_fr_xarm_mount>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink3_X_fr_xarm_mount();
        const Type_fr_xarmlink3_X_fr_xarm_mount& update(const JState&);
    protected:
    };
    
    class Type_fr_xarmlink3_X_fr_xarmlink6 : public TransformMotion<Scalar, Type_fr_xarmlink3_X_fr_xarmlink6>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink3_X_fr_xarmlink6();
        const Type_fr_xarmlink3_X_fr_xarmlink6& update(const JState&);
    protected:
    };
    
    class Type_fr_xarmlink6_X_fr_xarmlink3 : public TransformMotion<Scalar, Type_fr_xarmlink6_X_fr_xarmlink3>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink6_X_fr_xarmlink3();
        const Type_fr_xarmlink6_X_fr_xarmlink3& update(const JState&);
    protected:
    };
    
    class Type_fr_xarmlink6_X_fr_extruder_ee : public TransformMotion<Scalar, Type_fr_xarmlink6_X_fr_extruder_ee>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink6_X_fr_extruder_ee();
        const Type_fr_xarmlink6_X_fr_extruder_ee& update(const JState&);
    protected:
    };
    
    class Type_fr_extruder_ee_X_fr_xarmlink6 : public TransformMotion<Scalar, Type_fr_extruder_ee_X_fr_xarmlink6>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_extruder_ee_X_fr_xarmlink6();
        const Type_fr_extruder_ee_X_fr_xarmlink6& update(const JState&);
    protected:
    };
    
    class Type_fr_xarm_mount_X_fr_xarmlink1 : public TransformMotion<Scalar, Type_fr_xarm_mount_X_fr_xarmlink1>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarm_mount_X_fr_xarmlink1();
        const Type_fr_xarm_mount_X_fr_xarmlink1& update(const JState&);
    protected:
    };
    
    class Type_fr_xarmlink1_X_fr_xarm_mount : public TransformMotion<Scalar, Type_fr_xarmlink1_X_fr_xarm_mount>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink1_X_fr_xarm_mount();
        const Type_fr_xarmlink1_X_fr_xarm_mount& update(const JState&);
    protected:
    };
...
public:
    ...
    Type_fr_xarm_mount_X_fr_xarmlink3 fr_xarm_mount_X_fr_xarmlink3;
    Type_fr_xarmlink3_X_fr_xarm_mount fr_xarmlink3_X_fr_xarm_mount;
    Type_fr_xarmlink3_X_fr_xarmlink6 fr_xarmlink3_X_fr_xarmlink6;
    Type_fr_xarmlink6_X_fr_xarmlink3 fr_xarmlink6_X_fr_xarmlink3;
    Type_fr_xarmlink6_X_fr_extruder_ee fr_xarmlink6_X_fr_extruder_ee;
    Type_fr_extruder_ee_X_fr_xarmlink6 fr_extruder_ee_X_fr_xarmlink6;
    Type_fr_xarm_mount_X_fr_xarmlink1 fr_xarm_mount_X_fr_xarmlink1;
    Type_fr_xarmlink1_X_fr_xarm_mount fr_xarmlink1_X_fr_xarm_mount;
...
public:
    class Type_fr_xarm_mount_X_fr_xarmlink3 : public TransformForce<Scalar, Type_fr_xarm_mount_X_fr_xarmlink3>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarm_mount_X_fr_xarmlink3();
    ...
    class Type_fr_xarmlink3_X_fr_xarm_mount : public TransformForce<Scalar, Type_fr_xarmlink3_X_fr_xarm_mount>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink3_X_fr_xarm_mount();
    ...
    class Type_fr_xarmlink3_X_fr_xarmlink6 : public TransformForce<Scalar, Type_fr_xarmlink3_X_fr_xarmlink6>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink3_X_fr_xarmlink6();
    ...
    class Type_fr_xarmlink6_X_fr_xarmlink3 : public TransformForce<Scalar, Type_fr_xarmlink6_X_fr_xarmlink3>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink6_X_fr_xarmlink3();
    ...
    class Type_fr_xarmlink6_X_fr_extruder_ee : public TransformForce<Scalar, Type_fr_xarmlink6_X_fr_extruder_ee>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink6_X_fr_extruder_ee();
    ...
    class Type_fr_extruder_ee_X_fr_xarmlink6 : public TransformForce<Scalar, Type_fr_extruder_ee_X_fr_xarmlink6>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_extruder_ee_X_fr_xarmlink6();
    ...
    class Type_fr_xarm_mount_X_fr_xarmlink1 : public TransformForce<Scalar, Type_fr_xarm_mount_X_fr_xarmlink1>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarm_mount_X_fr_xarmlink1();
    ...
    class Type_fr_xarmlink1_X_fr_xarm_mount : public TransformForce<Scalar, Type_fr_xarmlink1_X_fr_xarm_mount>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink1_X_fr_xarm_mount();
...
public:
    class Type_fr_xarm_mount_X_fr_xarmlink3 : public TransformHomogeneous<Scalar, Type_fr_xarm_mount_X_fr_xarmlink3>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarm_mount_X_fr_xarmlink3();
    ...
    class Type_fr_xarmlink3_X_fr_xarm_mount : public TransformHomogeneous<Scalar, Type_fr_xarmlink3_X_fr_xarm_mount>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink3_X_fr_xarm_mount();
    ...
    class Type_fr_xarmlink3_X_fr_xarmlink6 : public TransformHomogeneous<Scalar, Type_fr_xarmlink3_X_fr_xarmlink6>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink3_X_fr_xarmlink6();
    ...
    class Type_fr_xarmlink6_X_fr_xarmlink3 : public TransformHomogeneous<Scalar, Type_fr_xarmlink6_X_fr_xarmlink3>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink6_X_fr_xarmlink3();
    ...
    class Type_fr_xarmlink6_X_fr_extruder_ee : public TransformHomogeneous<Scalar, Type_fr_xarmlink6_X_fr_extruder_ee>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink6_X_fr_extruder_ee();
    ...
    class Type_fr_extruder_ee_X_fr_xarmlink6 : public TransformHomogeneous<Scalar, Type_fr_extruder_ee_X_fr_xarmlink6>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_extruder_ee_X_fr_xarmlink6();
    ...
    class Type_fr_xarm_mount_X_fr_xarmlink1 : public TransformHomogeneous<Scalar, Type_fr_xarm_mount_X_fr_xarmlink1>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarm_mount_X_fr_xarmlink1();
    ...
    class Type_fr_xarmlink1_X_fr_xarm_mount : public TransformHomogeneous<Scalar, Type_fr_xarmlink1_X_fr_xarm_mount>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        Type_fr_xarmlink1_X_fr_xarm_mount();
